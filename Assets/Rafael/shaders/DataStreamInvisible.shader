Shader "Custom/DataStreamInvisible"
{
    Properties
    {
    ...
    SubShader
    {
        // ATAG ALTERADA: "Queue"="Geometry+2" garante que renderiza depois do Scanner
        Tags { "RenderType"="Opaque" "Queue"="Geometry+2" }
        LOD 100

        // A MAGIA DO STENCIL ACONTECE AQUI
        Stencil
        {
            Ref 1           // O número (senha) que estamos à procura
            Comp Equal      // Só desenha se o Stencil Buffer for IGUAL a 1
        }
